          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center ">
            ...
            <div className='space-y-10'>
              <div className='space-y-6'>
                ...
                {/* MAIN HEADING */}
                 <h1 className="text-5xl md:text-6xl lg:text-[55px] 2xl:text-7xl font-bold tracking-tight">
                 ...
                 {/* SUBTITLE */}
                <p className="text-lg lg:text-base 2xl:text-lg text-muted-foreground leading-relaxed max-w-xl font-medium">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className='flex -space-x-3'>
                     <Image
                      ...
                      width={48}
                      height={48}
                      className="w-12 h-12 lg:w-10 lg:h-10 2xl:w-12 2xl:h-12 rounded-full object-cover ring-4 ring-background"
                    />
                    <Image
                      src="/sam.jpg"
                      alt="Sam Miller"
                  ...
                  {/* RATING AND STATS */}
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex items-center gap-1">
                        {[1, 2, 3, 4, 5].map((star) => (
                          <StarIcon key={star} className="h-4 w-4 lg:h-3 lg:w-3 2xl:h-4 2xl:w-4 fill-amber-400 text-amber-400" />
                        ))}
                      </div>
                      <span className="text-sm lg:text-xs 2xl:text-sm font-bold text-foreground">4.9/5</span>
                    </div>
                    <p className="text-sm lg:text-xs 2xl:text-sm text-muted-foreground">
                      Trusted by{" "}
            ...
            <div className="relative lg:pl-40 2xl:pl-8 ">
               {/* GRADIENT ORBS */}
              ...
              <Image
                ...
                width={600}
                height={600}
                className="w-full h-auto  max-w-[260px] sm:max-w-[320px] md:max-w-[420px] lg:max-w-[420px] 2xl:max-w-[600px] mb-10"
              />
            </div>
          </div>
        </div>
