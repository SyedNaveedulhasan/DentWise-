    ...
    <section className='relative py-32 px-6 outline-hidden z-10 max-w-7xl mx-auto'>
      ...
      <div className="text-center mb-20">
        ...
        <h2 className='text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight'>
          ...
          <br />
          <span className='bg-gradient-to-br from-foreground to-foreground/70 bg-clip-text text-transparent '>better dental health</span>
        </h2>

        <p className='text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed'>
          Our streamlined process makes detal care accessible, convenient, and stress-free for everyone
        </p>
      </div>
