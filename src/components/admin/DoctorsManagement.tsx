            ...
            <Card>
                <CardHeader className="flex items-center justify-between">
                    <div>
                        ...
                        <CardDescription>Manage and oversea all doctors in your practice </CardDescription>
                    </div>
                    <Button onClick={() => setIsAddDialogOpen(true)}
                        className="bg-gradient-to-r from-primary to-primary/80 hover:form-primary/90 hover:to-primary/100 ">
